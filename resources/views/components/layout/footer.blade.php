<footer>
    <div class="w-full bg-white h-[400px] pc:h-[350px] pc-sp:h-[300px] sp:h-[270px] bg-[url('/public/images/layout/footer.png')] bg-contain bg-no-repeat bg-right-bottom relative flex justify-center sp:justify-end items-end">
